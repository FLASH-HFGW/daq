...
class MySwitch2Equipment(midas.frontend.EquipmentBase):
    """
    ...
    def __init__(self, client):
        ...
        print(f"TTi configured. Voltage on Ch{chan1}:", voltage)
    ...
    def readout_func(self):
        self.set_status("Running")
        self.client.msg("Switch has been operated. Now close.")
        return None
...
class MyFrontend(midas.frontend.FrontendBase):
    ...
    def __init__(self):
        ...
        midas.frontend.FrontendBase.__init__(self, "CryoSwitch_C-2")
        
        # You can add equipment at any time before you call `run()`, but doing
        # it in __init__() seems logical.
        self.add_equipment(MySwitch2Equipment(self.client))
    ...
    def frontend_exit(self):
        ...
        """
        self.equipment['CryoSwitch_C-2'].releController.close()
        self.equipment['CryoSwitch_C-2'].tti.close()
        self.equipment['CryoSwitch_C-2'].set_status("Stopped")
